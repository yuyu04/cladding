...
cladding 连**自己**也是用 cladding 造的 —— 276 个 feature 里有 272 个通过了同一道门禁，成为 [Ironclad](https://github.com/qwerfunch/ironclad) 标准的首个 L4 实现。
...
|---|---|---|---|---|
| v0.9.2（2026-07） | L4 · [自我声明](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 2784 / 2784 | 15 阶段 · 41 检测器 | 276（272 done） |

<sub>252 个测试文件 · 6 项 capability · 覆盖率下降由 COVERAGE_DROP 检测器拦下</sub>
